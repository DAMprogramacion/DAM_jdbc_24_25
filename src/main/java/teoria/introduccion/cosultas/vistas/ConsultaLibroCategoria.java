...
public class ConsultaLibroCategoria {
    ...
    public List<LibroCategoria> getLibrosCategoriaByCategoriaMejorado (String categoriaBusqueda) {
        List<LibroCategoria> libroCategorias = new ArrayList<>();
        String sql = "SELECT * FROM libro_categoria WHERE categoria = ?;";
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            statement.setString(1, categoriaBusqueda);
